...
class Settings extends PureComponent {
    ...
    goToAbout = preventDoubleTap(() => {
        ...
        const screen = 'About';
        const title = intl.formatMessage({id: 'about.title', defaultMessage: 'About {appTitle}'}, {appTitle: config.SiteName || 'SWAZM Community'});
            ...
            <View style={style.container}>
                ...
                >
                    ...
                    <SettingsItem
                        ...
                        messageValues={{appTitle: config.SiteName || 'SWAZM Community'}}
